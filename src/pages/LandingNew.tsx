            ...
            <div className="relative z-10 flex-1 flex items-center justify-center pt-4">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="text-center space-y-6">
                  ...
                  duration: 0.8,
                  delay: 0.6
                }} className="text-xl md:text-2xl max-w-3xl mx-auto py-8 text-stone-400">CashRidez connects riders and drivers directly for cash based rides with zero commissions. Join our ID-verified community powered transportation network. Maintain excellent ratings to qualify for weekly prizes and exclusive giveaways!</motion.p>
                </div>
              </div>
            </div>
          </section>
