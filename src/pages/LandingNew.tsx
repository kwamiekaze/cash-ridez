  ...
  return <>
      ...
      <div className="min-h-screen relative overflow-hidden bg-gradient-to-b from-white via-gray-50 to-white dark:from-black dark:via-gray-950 dark:to-black">
        ...
        <div className="relative z-10">
          ...
          {/* How It Works */}
          <section id="how-it-works" className="relative py-24 bg-gradient-to-br from-gray-900 via-black to-gray-900">
        <div className="container mx-auto px-4">
          <motion.div initial={{
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-yellow-400 via-yellow-200 to-yellow-400 bg-clip-text text-transparent animate-shimmer bg-[length:200%_auto]">
              How It Works
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {steps.map((step, i) => <motion.div key={i} initial={{
                ...
                delay: i * 0.2
              }} className="relative bg-gray-800 border border-yellow-500/20 rounded-2xl p-8 hover:border-yellow-500/40 transition-all shadow-lg">
      ...
      {/* Why Join CashRidez */}
      <section id="community" className="relative py-24 bg-gradient-to-br from-black via-gray-900 to-black">
        <div className="container mx-auto px-4">
          <motion.div initial={{
              opacity: 0,
              y: 20
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            {benefits.map((benefit, i) => <motion.div key={i} initial={{
                ...
                delay: i * 0.1
              }} className="bg-gray-800 border border-yellow-500/20 rounded-xl p-6 hover:border-emerald-500/40 transition-all text-center shadow-lg">
        ...
        {/* Support Section */}
        <section id="support" className="relative py-24 bg-gradient-to-br from-gray-900 via-black to-gray-900">
        <div className="container mx-auto px-4 text-center">
          <motion.div initial={{
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-yellow-400 via-yellow-200 to-yellow-400 bg-clip-text text-transparent animate-shimmer bg-[length:200%_auto]">
      ...
      <footer className="relative border-t border-yellow-500/20 py-12 bg-black">
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center items-center gap-8 mb-8">
            <motion.a
              href="https://instagram.com/cash.ridez"
              target="_blank"
            ...
            <motion.a
              href="https://www.tiktok.com/@cashridez"
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ scale: 1.1 }}
              className="text-yellow-400 hover:text-yellow-300 transition-colors"
            ...
            <motion.a
              href="https://x.com/cashridez?s=21"
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ scale: 1.1 }}
              className="text-yellow-400 hover:text-yellow-300 transition-colors"
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-8">
            ...
            <div className="flex gap-6 text-gray-400 text-sm">
              ...
              <button onClick={() => setIsSupportOpen(true)} className="hover:text-yellow-400 transition-colors">
                Contact
              </button>
            </div>
          </div>
          ...
          <div className="border-t border-yellow-500/10 pt-8 text-center">
            <p className="text-xs text-gray-500 max-w-4xl mx-auto mb-4">
