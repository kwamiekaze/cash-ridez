  ...
  return (
    <div className={`absolute inset-0 overflow-hidden ${className}`}>
      ...
      >
        ...
        {showRiders && (
          <g>
            <circle cx="15%" cy="15%" r="4" fill="url(#nodeGlow)" />
            <circle cx="85%" cy="20%" r="4" fill="url(#nodeGlow)" />
            <circle cx="12%" cy="85%" r="4" fill="url(#nodeGlow)" />
            <circle cx="88%" cy="80%" r="4" fill="url(#nodeGlow)" />
            <circle cx="25%" cy="60%" r="4" fill="url(#nodeGlow)" />
          </g>
        )}
      </svg>
