...
DROP POLICY IF EXISTS "Riders can update their rides (old open/assigned)" ON public.ride_requests;
DROP POLICY IF EXISTS "Assigned drivers can update their rides (old assigned)" ON public.ride_requests;
